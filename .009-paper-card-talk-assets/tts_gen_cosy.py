#!/usr/bin/env python3
"""DashScope CosyVoice 批量生成版（对应 tts_gen.py 的 edge-tts 版）。

- 走 cosyvoice-v3-flash（plus / v3.5 系列当前 key 未开通）
- 默认音色 zh-CN longtian_v3（磁性理智男 · 咨询调）
- 默认 rate=1.1，pace 跟 edge-yunyang +10% 基本对齐
- 落地 audio/NNNN.mp3，幂等（--force 强制重生）
