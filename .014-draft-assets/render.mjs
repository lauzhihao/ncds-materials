 ...
 *
 * 用法（仓库根目录）：
 *   node .014-draft-assets/render.mjs
 *
 * 输出：.014-draft-assets/output/014-draft.mp4
 *
 * 需要：
...
const OUTPUT_MP4 = path.join(OUTPUT_DIR, '014-draft.mp4');
const TMP_VIDEO = '/tmp/012-render-silent.mp4';
const TMP_AUDIO = '/tmp/012-render-audio.mp3';
const HTTP_PORT = 8765;
const URL_012 = `http://127.0.0.1:${HTTP_PORT}/014-draft.html`;
const FPS = 30;
